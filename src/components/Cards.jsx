...
import lavandaDark from '../assets/lavandaDark.svg'
import luminariaDark from '../assets/luminariaDark.svg'
import relogioDark from '../assets/relogioDark.svg'
import celularDark from '../assets/celularDark.svg'

export default function Cards({ isDarkMode }) {
  return (
    <div className='hidden lg:block 2xl:mt-24 2xl:mb-24'>
        <div className='flex gap-2.5 mb-20 flex justify-center xl:gap-8 xl:mb-24'>
            ...
            dark:bg-bg-cards'>
                <img className='w-10 mb-3' src={isDarkMode ? lavandaDark : lavanda} alt="" />
            ...
            bg-secao-diferencial w-56 h-48 rounded-3xl py-6 px-6 flex flex-col items-center
            dark:bg-bg-cards'>
                <img className='w-10 mb-3' src={isDarkMode ? luminariaDark : luminaria} alt="" />
            ...
            bg-secao-diferencial w-56 h-48 rounded-3xl py-6 px-6 flex flex-col items-center
            dark:bg-bg-cards'>
                <img className='w-10 mb-3' src={isDarkMode ? relogioDark : relogio} alt="" />
            ...
            bg-secao-diferencial w-56 h-48 rounded-3xl py-6 px-6 flex flex-col items-center
            dark:bg-bg-cards'>
                <img className='w-10 mb-3' src={isDarkMode ? celularDark : celular} alt="" />
