    ...
    <div>
        <div>
            ...
            <div className='flex justify-between gap-3 mb-20'>
                <button className='w-[160px] h-[38px] font-karla text-branco text-[14px] bg-roxo-claro rounded-l-xl rounded-br-3xl hover:cursor-pointer'>Saiba mais</button>

                <button className='w-[160px] h-[38px] font-karla text-[14px] text-roxo-claro border-2 border-roxo-claro rounded-tl-lg rounded-tr-lg rounded-br-lg rounded-bl-lg hover:cursor-pointer'>Sobre nós</button>
            </div>
