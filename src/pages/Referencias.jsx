...
export default function SobreNos() {
  return (
    <div>
        <Header />
        <div>   
            <h1 className='font-karla font-bold text-[25px] mt-16 mb-16'>A <span style={{background: 'linear-gradient(to right, #735EA0 0%, #5EA079 50%, #4C8293 100%)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent'}}>credibilidade</span> é a chave para a confiança</h1>
        ...
        <div className='flex flex-col items-center justify-center px-[16px]'>
            <h2 className='font-karla font-medium text-[19px] mb-8'>Artigos de embasamento científico</h2>
            <p className='font-overpass text-cinza mb-8 text-[14px]'>Clique para ser direcionado</p>
        </div>

        <div className='text-roxo-titulo text-[14px] font-medium text-justify flex flex-col justify-center items-center px-[16px]'>
            <a className='hover:cursor-pointer mb-3' href="https://recima21.com.br/index.php/recima21/article/view/2415" target="_blank">Influência dos ruídos brancos na qualidade do sono</a>
            <a className='hover:cursor-pointer mb-3' href="http://www.mastereditora.com.br/periodico/20140702_165353.pdf" target="_blank">Transtornos do ciclo sono-vigília/circadiano</a>
            <a className='hover:cursor-pointer' href="https://bjihs.emnuvens.com.br/bjihs/article/view/1462" target="_blank">Influência dos óleos essenciais na melhoria do sono</a>
        </div>
    </div>
  )
}
