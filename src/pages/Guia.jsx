    ...
    return (
        ...
        dark:bg-bg-usodiario">
            ...
            w-full order-1 md:order-2'>
                ...
                lg:text-[25px]
                md:text-right
                text-[21px] font-karla font-bold mb-12 dark:text-white">Confira um vídeo de <br></br> <span className="text-azul-titulo">apresentação</span> do Cloudy</h2>

                    <div className='text-left'>
                        <p className="
                    xl:text-[18px]
                    md:mb-0 
                    font-overpass text-[16px] text-justify mb-12 dark:text-white">O Cloudy é muito fácil de usar. Assista ao vídeo e entenda como utilizá-lo em conjunto com o aplicativo, uma funcionalidade que nos diferencia.</p>
                    </div>
                </div>
