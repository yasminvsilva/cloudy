...
export default function SobreNos() {
  return (
    <div>
        ...
        <div>   
            <h1 className='font-karla font-bold text-[26px] mt-16 mb-16 text-center leading-[125%]'>Saiba quem são os nossos <span className='text-roxo-titulo'>desenvolvedores</span></h1>
            ...
            <p className='font-overpass text-[16px] text-justify mb-20'>Vimos na aromaterapia uma oportunidade de desenvolver um dispositivo que, não apenas ajudasse a combater os distúrbios do sono, mas também oferecesse um ambiente relaxante por meio da música e iluminação âmbar.</p>
        </div>
