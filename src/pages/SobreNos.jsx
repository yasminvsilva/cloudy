...
export default function SobreNos() {
  return (
    <div>
        ...
        <Header />
        <div>   
            <h1 className='font-karla font-bold text-[25px] mt-16 mb-16 text-center'>Saiba quem são os nossos <span style={{background: 'linear-gradient(to right, #735EA0 0%, #5EA079 50%, #4C8293 100%)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent'}}>desenvolvedores</span></h1>
