...
import luaDark from '../assets/luaModoEscuro.svg'
                ...
                <ul className='ml-4'>
                  <li>
                    <button className='flex gap-3'>
                      <img className="hover:cursor-pointer transition-transform duration-300 ease-in-out"
                        src={isLuaHovered ? luaHovered : luaDark}
                        alt="Ícone de lua"
